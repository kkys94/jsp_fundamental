...
<head>
    ...
    <script>
        ...
        //    $('#sendMember').bind("click, keypress", function(event){
        //    $('#sendMember').on("click, keypress", function(event){
                //원래의 기능을 못쓰게 한다.
                //submit 버튼의 기능 : action 으로 페이지를 이동
